...
\begin{frame}{(d) ``Alta probabilidad'': la cota cuantitativa}
  ...
  \begin{columns}[T]
    ...
    \begin{exampleblock}{\small Fuente}
      \small El paper \emph{no} incluye esta cota
      (y tiene una errata).\\
...
\begin{frame}{La parte cuántica: hallar el período}
  ...
  \begin{enumerate}
    ...
    \item Hadamards en conteo $\to$ superposición uniforme.
...
\begin{frame}{Criptografía post-cuántica: NIST PQC}
  ...
  \begin{tabular}{llll}
    ...
    FIPS 206 & \textbf{FN-DSA} (Falcon)    & Firma digital     & en proceso (2026) \\
